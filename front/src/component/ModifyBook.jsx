	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await axios.put(
				`http://localhost:8000/books/${currentBook}`,
				{
					cover: cover,
					brief: brief,
					creator: creator,
	...
	return (
		<form onSubmit={handleSubmit}>
			<div>
				...
				<input type="text" onChange={(e) => setCurrentBook(e.target.value)} />
			</div>
			<div>
				<label>Cover:</label>
				<input
			...
			<div>
				<label>Creator:</label>
				<input type="text" onChange={(e) => setCreator(e.target.value)} />
			</div>
			<div>
				<label>Name:</label>
			...
			<div>
				...
				<input type="text" onChange={(e) => setBookInfo(e.target.value)} />
			</div>
			<div>
				<label>Book Publisher:</label>
				<input type="text" onChange={(e) => setBookPublisher(e.target.value)} />
			</div>
			<div>
				<label>Book Preview:</label>
				<input type="text" onChange={(e) => setBookPreview(e.target.value)} />
			</div>
			<div>
				<label>Critic Review:</label>
				<input type="text" onChange={(e) => setCriticReview(e.target.value)} />
			</div>
			<div>
				<label>Content:</label>
				<input
