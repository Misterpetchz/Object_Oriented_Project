...
import AddBookToStock from "../component/addBookToStock";
import RemoveBookFromStock from "../component/removeBookFromStock";
			...
			<div>
				<form>
					...
					<div>
						...
						<input type="text" onChange={(e) => setAddBrief(e.target.value)} />
					</div>
					<div>
